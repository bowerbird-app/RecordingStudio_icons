...
module RecordingStudioIcons
  module Generators
    # Generator to install RecordingStudioIcons migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_icons:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioIcons migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioIcons engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_icons_examples.rb")
